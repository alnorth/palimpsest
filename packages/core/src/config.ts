...
export const PALIMPSEST_CONFIG: SphereConfig[] = [
  {
    ...
    agendas: [
      ...
      { id: 'agenda-tab'      as AgendaId, title: 'TAB',      key: 't' },
      { id: 'agenda-devoteam' as AgendaId, title: 'Devoteam', key: 'o' },
    ],
    contexts: [
  ...
  },
  {
    ...
    agendas: [
      ...
      { id: 'agenda-inspire' as AgendaId, title: 'Inspire', key: 'i' },
    ],
    contexts: [
      ...
      { id: 'ctx-deepthought' as ContextId, name: 'Deep thought', key: 'f' },
    ],
  },
]
