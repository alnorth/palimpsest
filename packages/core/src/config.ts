...
export const PALIMPSEST_CONFIG: SphereConfig[] = [
  {
    ...
    agendas: [
      ...
      { id: 'agenda-tab'      as AgendaId, title: 'TAB' },
      { id: 'agenda-devoteam' as AgendaId, title: 'Devoteam' },
    ],
    contexts: [
  ...
  },
  {
    ...
    contexts: [
      ...
      { id: 'ctx-errands'     as ContextId, name: 'Errands' },
      { id: 'ctx-daytime'     as ContextId, name: 'Daytime' },
      { id: 'ctx-gaming'      as ContextId, name: 'Gaming' },
      { id: 'ctx-weekdaytime' as ContextId, name: 'Weekdaytime' },
      { id: 'ctx-deepthought' as ContextId, name: 'Deep thought' },
    ],
  },
]
