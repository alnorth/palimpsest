...
import { useAppState, getDueDatePreview, getRecurrencePreview, handleKey, getTaskDetailFields, isMainListItems } from 'palimpsest-ui-core'
...
function App({ store }: { store: PalimpsestStore }) {
...
function LoadedApp({ store, initialState }: { store: PalimpsestStore; initialState: ProjectionState }) {
...
export function runTui(store: PalimpsestStore): void {
  render(<App store={store} />, { alternateScreen: true })
}
